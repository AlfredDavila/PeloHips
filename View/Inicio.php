            ...
            <div class="col-md-2">
                ...
                <div class="list-group">
                    <?php foreach ($categorias as $categoria) { ?>
                        <a <?php echo $utl->getLink('Categoria', array('Categoria'=>$categoria['nombre'])); ?> class="list-group-item"><?php echo $categoria['nombre']; ?></a>
                    <?php } ?>
                </div>
            </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <p>$<?php echo $producto["precio"]; ?> <a <?php  echo $utl->getDataAttr('add', $producto); echo $utl->popOver('Agregado', $producto["nombre"] . ' agregado');?> class="btn btn-default btn-xs producto" role="button">Agregar</a></p>
                                </div>
                            </div>
                        </div>
                    <?php }?>
