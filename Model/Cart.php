...
class Model_Cart
{
    ...
    private $carrito;
    //Array de un articulo
    private $articuloKeys = array(
         'nombre'=>null,
         'id'=>null,
         'cantidad'=>null,
         'precio'=>null,
    ...
    public function setProducto($articulo = array())
    {
        ...
        if(count(array_diff_key($this->articuloKeys, $articulo)))
        {
            throw new Exception("Error, el articulo debe tener " . print_r(array_keys($this->articuloKeys), true), 1);    
        }
        ...
        $this->carrito[$unique_id] = $articulo;
    ...
    private function setPrecioCantidad()
    {
        ...
        $this->carrito["articulos_total"] = $articulos;
        $this->carrito["precio_total"] = $precio;
    ...
    public function deleteProducto($unique_id)
    {
